...
const HomePage = () => {
  useSEO({
    ...
    keywords: 'детский конкурс, детский фестиваль, конкурсы для детей, творческий конкурс для детей, вокальный конкурс, хореографический конкурс, международный конкурс для детей, всероссийский конкурс для детей, конкурс ИНДИГО, конкурс-фестиваль, фестиваль детского творчества, конкурсы фестивали России, очный заочный онлайн конкурс, гран-при, лауреат, дипломант',
    path: '/',
  });
