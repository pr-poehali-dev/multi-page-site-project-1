      ...
      <section className="pt-32 pb-20 px-4 relative overflow-hidden">
        ...
        <div className="container mx-auto relative z-10">
          <div className="max-w-4xl mx-auto text-center animate-fade-in relative">
            ...
            <img src="https://cdn.poehali.dev/projects/ecdaf1c5-6d12-4487-8a18-89243ebbcc9e/bucket/d7969e35-7237-45a5-a6f9-1478e611b8d5.png" alt="Здесь рождаются звезды!" className="mx-auto mt-[-55px] mb-[10px] w-auto max-w-3xl" style={{ height: 'clamp(90px, 22vw, 200px)', filter: 'contrast(1.3) brightness(0.85)' }} />
