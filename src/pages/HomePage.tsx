      ...
      <section className="pt-32 pb-20 px-4 relative overflow-hidden">
        ...
        <div className="container mx-auto relative z-10">
          <div className="max-w-4xl mx-auto text-center animate-fade-in relative">
            ...
            <img src="https://cdn.poehali.dev/projects/ecdaf1c5-6d12-4487-8a18-89243ebbcc9e/bucket/e853a45e-50ab-473d-9dde-5f1084140f3c.png" alt="Здесь рождаются звезды!" className="mx-auto my-[17px] w-auto max-w-2xl" style={{ height: 'clamp(48px, 12vw, 120px)' }} />
