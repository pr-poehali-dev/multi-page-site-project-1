...
const JuryPage = () => {
  useSEO({
    title: 'Жюри конкурсов — эксперты по вокалу, хореографии и театру',
    description: 'Профессиональное жюри конкурсов ИНДИГО — заслуженные деятели искусства, педагоги по вокалу, хореографии, театру и инструментальной музыке. Прозрачные критерии оценки.',
    keywords: 'жюри конкурса, критерии оценки конкурса, эксперты по вокалу, эксперты по хореографии, деятели искусства, жюри ИНДИГО, семинары для педагогов, электронная система оценок, обратная связь от жюри, мастер-класс от жюри',
    path: '/jury',
  });
