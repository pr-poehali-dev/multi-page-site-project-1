...
const JuryPage = () => {
  useSEO({
    ...
    keywords: 'жюри конкурса, критерии оценки конкурса, эксперты по вокалу, эксперты по хореографии, деятели искусства, жюри ИНДИГО, семинары для педагогов, электронная система оценок',
    path: '/jury',
  });
