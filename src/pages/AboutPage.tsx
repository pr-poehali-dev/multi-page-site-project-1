          ...
          <div className="max-w-3xl mx-auto mb-20 space-y-8 animate-fade-in">
            ...
            <Card className="p-8 md:p-12 bg-gradient-to-br from-primary/5 to-secondary/5 shadow-xl">
              <p className="text-lg md:text-xl leading-relaxed text-center">
                Наша платформа объединяет музыкантов, вокалистов, танцоров и других творческих личностей. Мы ежегодно проводим <span className="font-bold text-primary">50+ фестивалей-конкурсов</span>, где принимают участие артисты из <span className="font-bold text-secondary">5 стран мира</span>. А наши проекты включаются в Перечень мероприятий, результаты которых заносятся в Государственный реестр лиц, проявивших выдающиеся способности (ГИР), а полученные дипломы засчитываются в портфолио при поступлении в «Артек», «Орлёнок», «Океан» и другие всероссийские детские центры.
              </p>
            </Card>
