...
const ResultsPage = () => {
  useSEO({
    ...
    keywords: 'результаты конкурса, итоги конкурса, список лауреатов конкурса, дипломанты конкурса, протоколы оценивания, гран при конкурса, обладатель гран-при, лауреат конкурса',
    path: '/results',
  });
