...
const SponsorsPage = () => {
  useSEO({
    title: 'Партнёры и спонсоры конкурсов',
    description: 'Партнёры и спонсоры международных и всероссийских конкурсов ИНДИГО. Узнайте, кто поддерживает развитие юных талантов в России и странах СНГ.',
    keywords: 'партнёры конкурса, спонсоры детского конкурса, поддержка юных талантов, стать партнёром конкурса',
    path: '/sponsors',
  });
