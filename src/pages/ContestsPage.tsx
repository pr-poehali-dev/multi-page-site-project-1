...
const ContestsPage = () => {
  useSEO({
    ...
    keywords: 'календарь конкурсов, конкурс вокала, конкурс хореографии, конкурс танцев, театральный конкурс, конкурс инструментальной музыки, всероссийский конкурс, международный конкурс, подать заявку на конкурс, конкурс-фестиваль, положение о конкурсе, очный заочный онлайн конкурс',
    path: '/contests',
  });
