      ...
      <section className="px-4 md:px-8 pb-20">
        <div className="max-w-5xl mx-auto">
          <div className="rounded-2xl border border-border bg-muted/30 p-8 md:p-12">
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              Помимо участников из России, конкурсы ИНДИГО ежегодно собирают творческие коллективы и солистов из <span className="font-semibold text-foreground">Беларуси</span> (Минск, Гомель, Витебск, Могилёв, Гродно, Брест), <span className="font-semibold text-foreground">Казахстана</span> (Алматы, Астана, Шымкент, Караганда) и <span className="font-semibold text-foreground">Узбекистана</span> (Ташкент, Самарканд, Бухара, Фергана). Международный статус конкурса позволяет участникам из стран СНГ получать дипломы лауреата и дипломанта, признаваемые на территории России и за рубежом.
            </p>
