...
const ContestCard = ({ contest, index, isPast }: { contest: Contest; index: number; isPast: boolean }) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative bg-muted" style={{ aspectRatio: '10/9' }}>
        {contest.poster_url ? (
          <img
...
const ContestsPage = () => {
  useSEO({
    ...
    keywords: 'календарь конкурсов, конкурс вокала, конкурс хореографии, конкурс танцев, театральный конкурс, конкурс инструментальной музыки, всероссийский конкурс, международный конкурс, подать заявку на конкурс, конкурс-фестиваль, положение о конкурсе, очный заочный онлайн конкурс, тур на конкурс, поездка на фестиваль',
    path: '/contests',
  });
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="sr-only">
        <h2>География конкурсов ИНДИГО</h2>
        <p>
          Конкурсы и фестивали ИНДИГО имеют международный и всероссийский статус — принять участие может любой творческий коллектив или солист независимо от места проживания. Мы принимаем заявки из всех регионов России: Москвы и Московской области, Санкт-Петербурга, Воронежской, Белгородской, Курской, Липецкой, Тамбовской областей, а также из республик и краёв Северного Кавказа, Поволжья, Урала, Сибири и Дальнего Востока — Татарстана, Башкортостана, Краснодарского и Ставропольского края, Свердловской, Новосибирской, Челябинской, Самарской, Ростовской, Нижегородской и других областей.
        </p>
        <p>
          Помимо участников из России, конкурсы ИНДИГО ежегодно собирают творческие коллективы и солистов из Беларуси (Минск, Гомель, Витебск, Могилёв, Гродно, Брест), Казахстана (Алматы, Астана, Шымкент, Караганда) и Узбекистана (Ташкент, Самарканд, Бухара, Фергана). Международный статус конкурса позволяет участникам из стран СНГ получать дипломы лауреата и дипломанта, признаваемые на территории России и за рубежом.
        </p>
        <p>
          Для участников из отдалённых регионов и других стран доступны заочная и онлайн-формы участия — достаточно прислать видеозапись выступления, чтобы побороться за призовые места наравне с очными конкурсантами.
        </p>
      </section>
