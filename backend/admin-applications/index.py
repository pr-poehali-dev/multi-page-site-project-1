...
def handle_vk_parser(event: Dict[str, Any]) -> Dict[str, Any]:
    ...
    # Города ДНР/ЛНР в базе городов VK не привязаны к региону/стране (ДНР и ЛНР официально
    # не выделены как субъект в справочнике VK), поэтому поиск database.getCities с
    # country_id=1 (Россия) их не находит. Это фиксированные внутренние id VK для этих
    ...
    EXTRA_CITIES = [
        ...
        {'id': 3521, 'title': 'Макеевка', 'region': 'ДНР', 'area': ''},
        {'id': 2256, 'title': 'Горловка', 'region': 'ДНР', 'area': ''},
        {'id': 5648, 'title': 'Алчевск', 'region': 'ЛНР', 'area': ''},
        {'id': 6676, 'title': 'Енакиево', 'region': 'ДНР', 'area': ''},
        {'id': 3369, 'title': 'Стаханов', 'region': 'ЛНР', 'area': ''},
        {'id': 3454, 'title': 'Северодонецк', 'region': 'ЛНР', 'area': ''},
        {'id': 4832, 'title': 'Торез', 'region': 'ДНР', 'area': ''},
        {'id': 3518, 'title': 'Снежное', 'region': 'ДНР', 'area': ''},
        {'id': 3928, 'title': 'Антрацит', 'region': 'ЛНР', 'area': ''},
        {'id': 1507264, 'title': 'Красный Луч', 'region': 'ЛНР', 'area': ''},
        {'id': 6871, 'title': 'Кировск', 'region': 'ЛНР', 'area': ''},
    ]
